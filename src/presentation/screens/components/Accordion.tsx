...
import ClassicAccordion from '../../components/common/Accordion/ClassicAccordion';
import AccordionHighlight from '../../components/common/Accordion/AccordionHighlight';
