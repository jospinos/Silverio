...
import {  COLORS, FONTS, IMAGES } from '../theme/theme';
...
const Header = (props:any) => {
    ...
    return (
        <View style={[GlobalStyleSheet.headerstyle,GlobalStyleSheet.container, {padding:0, backgroundColor:colors.card,borderBottomColor:colors.border}, transparent == true && {position:'absolute',left:0,right:0,top:0,zIndex:1, backgroundColor:'transparent',borderBottomWidth:0}]}>
            <View>
                <TouchableOpacity
